...
public class mobiliarios extends medio {
    private String tipo;
    ...
    public mobiliarios(String tipo, String proveedor, String tiempo_de_uso, String ubucacion, String tipo_de_medio, int numero_de_inventario, double costo_unitario, String estado) {
