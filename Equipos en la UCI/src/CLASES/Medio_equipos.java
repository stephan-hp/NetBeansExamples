...
public class Medio_equipos extends Medio {
    private String tipo;
    ...
    public Medio_equipos(String tipo, String marca, String proveedor_usual, String proveedores_posibles, int annos_garantia, String tipo_de_medio, int numero_de_inventario, double costo_unitario, String estado) {
